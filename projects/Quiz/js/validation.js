...
function checkAnswers(checkbox_points){
	...
	while(element_name.length>0){
		...
		$("input[name=" + name +"]").first().parent(appended).prevAll(".description:first").append("<div class='points'> "+ Number(points_for_question).toFixed(2) +"/1 Point(s0</div>");
	...
	while(element_name.length>0){
		...
		$("input[name=" + name +"]").first().parent(appended).prevAll(".description:first").append("<div class='points'> "+ Number(points_for_question).toFixed(2) +"/1 Point(s)</div>");
		points_for_question = 0;
